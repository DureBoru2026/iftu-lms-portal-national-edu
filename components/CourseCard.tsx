...
const CourseCard: React.FC<CourseCardProps> = ({ 
  ...
  return (
    ...
    >
      ...
      {/* Thumbnail */}
      <div className="relative h-60 border-b-8 border-black bg-gradient-to-br from-slate-800 to-black overflow-hidden">
        <img 
        ...
        />
        <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-white text-center bg-gradient-to-br from-blue-900 via-slate-900 to-black z-0">
          <span className="text-4xl mb-2">📚</span>
          <span className="font-black text-lg uppercase italic tracking-wide">{course.title}</span>
        </div>
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent group-hover:from-black/40 transition-colors z-15" />
