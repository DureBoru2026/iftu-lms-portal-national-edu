  ...
  return (
    <div className="max-w-5xl mx-auto py-12 px-6 animate-fadeIn pb-40">
      ...
      <div className="text-center space-y-8 mb-20 no-print">
        ...
        <div className="bg-gradient-to-r from-slate-900 via-blue-950 to-black text-white border-8 border-black rounded-[4rem] p-8 md:p-10 shadow-[16px_16px_0px_0px_rgba(251,191,36,1)] flex flex-col md:flex-row items-center gap-8 max-w-4xl mx-auto text-left">
          <div className="relative shrink-0 w-40 h-40 md:w-48 md:h-48">
            <img 
              ...
              className="w-full h-full rounded-[2.5rem] border-4 border-amber-400 object-cover shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative z-10"
              onError={(e) => {
                (e.target as HTMLElement).style.opacity = '0';
              }}
            />
            <div className="absolute inset-0 rounded-[2.5rem] border-4 border-amber-400 bg-gradient-to-br from-amber-400 via-yellow-400 to-amber-600 flex items-center justify-center font-black text-4xl text-black z-0">
              JFH 👑
            </div>
            <span className="absolute -bottom-2 -right-2 bg-amber-400 border-2 border-black rounded-xl px-2.5 py-0.5 text-xs font-black text-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] z-20">
              👑 Founder & Lead
            </span>
          </div>
          ...
          <div className="space-y-3 text-center md:text-left flex-1">
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-2">
              <span className="px-3 py-1 bg-amber-400 text-black font-black border-2 border-black rounded-lg text-[10px] uppercase tracking-widest italic">
                LEAD DEVELOPER & FOUNDER
              </span>
              <span className="px-3 py-1 bg-blue-600 text-white font-black border-2 border-black rounded-lg text-[10px] uppercase tracking-widest italic">
                SOVEREIGN SYSTEM ARCHITECT
              </span>
            </div>
            <h3 className="text-3xl md:text-5xl font-black uppercase italic tracking-tight text-white">
              JEMAL FANO HAJI
            </h3>
            <p className="text-sm md:text-base font-bold text-amber-300 italic">
              West Arsi Zone, Kore Woreda // Biftu Beri Sec. School
            </p>
